-- Add Shady Al-Suleiman guest review to homepage testimonials.
...
inserted AS (
    ...
    SELECT
        'dddddddd-dddd-dddd-dddd-dddddddddd21'::uuid,
        h.id,
        nv.version_number,
        'Homepage guest review: Shady Al-Suleiman',
        jsonb_build_object(
    ...
    WHERE NOT EXISTS (
        ...
        WHERE existing.id = 'dddddddd-dddd-dddd-dddd-dddddddddd21'::uuid
    )
