-- Add Vahap Sanal guest video review to homepage testimonials.
...
inserted AS (
    ...
    SELECT
        'dddddddd-dddd-dddd-dddd-dddddddddd23'::uuid,
        h.id,
        nv.version_number,
        'Homepage guest review: Vahap Sanal',
        jsonb_build_object(
    ...
    WHERE NOT EXISTS (
        ...
        WHERE existing.id = 'dddddddd-dddd-dddd-dddd-dddddddddd23'::uuid
    )
