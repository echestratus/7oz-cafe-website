-- Add the Nauru guests' terrace review to homepage testimonials.
...
SET data = $json${
  ...
  "items": [
    ...
    },
    {
      ...
      "review": "Hi everyone — we're at 7Oz Espresso. We had a double espresso, and the quality of the coffee, the atmosphere, the energy — everything was perfect. Thank you to everyone here. I invite you all to come and experience this.",
      "avatarSrc": "/assets/reviews/vahap-sanal.webp",
      "videoSrc": "/assets/reviews/vahap-sanal.mp4"
    },
    {
      "name": "Guests from Nauru",
      "review": "We're at the Hadith Hotel, having cappuccino. My two friends are here, and the view is wonderful. We love the cappuccino. If you want one, come to the Hadith Hotel.",
...
inserted AS (
    ...
    SELECT
        'dddddddd-dddd-dddd-dddd-dddddddddd24'::uuid,
        h.id,
        nv.version_number,
        'Homepage guest review: Guests from Nauru',
        jsonb_build_object(
    ...
    WHERE NOT EXISTS (
        ...
        WHERE existing.id = 'dddddddd-dddd-dddd-dddd-dddddddddd24'::uuid
    )
