...
export const CAFE_LOCATIONS: readonly CafeLocation[] = [
  {
    ...
    status: 'open',
    imageSrc: '/assets/locations/7Oz-current.webp',
  ...
  },
  {
    ...
    status: 'coming_soon',
    imageSrc: '/assets/locations/7Oz-mecca.webp',
  ...
  },
  {
    ...
    status: 'coming_soon',
    imageSrc: '/assets/locations/7Oz-hadith.webp',
  ...
  },
  {
    ...
    status: 'coming_soon',
    imageSrc: '/assets/locations/7Oz-humble-8.webp',
